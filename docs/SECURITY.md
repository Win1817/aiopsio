...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on ai-ops.
...
3. **In-Depth Understanding**: Reports must reflect a clear understanding of the codebase, how ai.ops is used and provide specific details about the vulnerability, including the affected components and potential impacts.
...
6. **Default Configuration Testing**: All vulnerability reports must be tested and reproducible using ai.ops's out-of-the-box default configuration. Claims of vulnerabilities that only manifest with explicitly weakened security settings may be discarded, unless they are covered by the following exception:
...
7. **Threat Model Understanding Required**: Reports must demonstrate understanding of ai.ops's self-hosted, authenticated, extensible, role-based access control architecture. Comparing ai.ops to services with fundamentally different security models without acknowledging the architectural differences may result in report rejection.
...
>
> - If we suspect you used AI (but you did not disclose it to us), we will be asking thorough follow-up questions to validate your understanding of the reported vulnerability and ai.ops itself.
...
> - had a clear lack of understanding of ai.ops
...
If you want to report a vulnerability and can meet the outlined requirements, [open a vulnerability report here](https://github.com/ai-ops/ai-ops/security/advisories/new).
...
Due to the volume of incoming vulnerability reports, issues, discussions, pull requests, and general project maintenance — lately compounded by a large number of invalid AI-generated reports (see [AI report transparency](#ai-report-transparency)) — our capacity to respond is limited. ai.ops is a community-driven project maintained by a small team, and security reports are handled alongside all other project responsibilities.
...
Premature disclosure undermines the security of all ai.ops users and **violates the trust** inherent in the responsible disclosure process. **Reporters who publicly disclose vulnerability details before official publication <ins>may be permanently banned from future reporting.</ins>**
...
- **Documentation issues/improvement ideas:** Open an issue on our [Documentation Repository](https://github.com/ai-ops/docs)
- **Feature requests:** Create a discussion in [GitHub Discussions - Ideas](https://github.com/ai-ops/ai-ops/discussions/) to discuss with the community if this feature request is wanted by multiple people
...
- **General issues:** Use our [Issue Tracker](https://github.com/ai-ops/ai-ops/issues)
...
Please use the adequate channel for your specific issue - e.g. best-practice guidance or additional documentation needs into the [Documentation Repository](https://github.com/ai-ops/docs), and feature requests into the Main Repository as an issue or discussion.
...
For any other immediate concerns and questions, please create an issue in our [issue tracker](https://github.com/ai-ops/ai-ops/issues) or contact our team on [Discord](https://discord.gg/5rJgQTnV4s).
