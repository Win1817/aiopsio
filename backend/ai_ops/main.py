...
from ai_ops.utils import logger
from ai_ops.utils.audit import AuditLevel, AuditLoggingMiddleware
from ai_ops.utils.logger import start_logger
...
from ai_ops.internal.db import ScopedSession, engine, get_session

from ai_ops.models.functions import Functions
from ai_ops.models.models import Models
from ai_ops.models.users import UserModel, Users
...
from ai_ops.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
    get_filtered_models,
)
from ai_ops.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
)
from ai_ops.utils.actions import chat_action as chat_action_handler
from ai_ops.utils.embeddings import generate_embeddings
from ai_ops.utils.middleware import (
    build_chat_response_context,
    process_chat_payload,
    process_chat_response,
)
from ai_ops.utils.tools import set_tool_servers, set_terminal_servers

from ai_ops.utils.auth import (
    get_license_data,
...
from ai_ops.utils.plugin import install_tool_and_function_dependencies
from ai_ops.utils.oauth import (
...
from ai_ops.utils.security_headers import SecurityHeadersMiddleware
from ai_ops.utils.redis import get_redis_connection

from ai_ops.tasks import (
...
from ai_ops.utils.redis import get_sentinels_from_env
...
if ENABLE_OTEL:
    from ai_ops.utils.telemetry.setup import setup as setup_opentelemetry
...
from ai_ops.utils.access_control import migrate_access_control
        ...
        if request.method == 'GET':
            ...
            if 'shared' in query_params and len(query_params['shared']) > 0:
                ...
                if text:
                    ...
                    if urls:
                        from ai_ops.retrieval.loaders.youtube import _parse_video_id
...
from ai_ops.utils.anthropic import (
...
async def generate_messages(
    ...
    All models configured in ai.ops are accessible via this endpoint.
    ...
    try:
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                'https://api.github.com/repos/ai-ops/ai-ops/releases/latest',
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for ai.ops.
