...
from ai_ops.models.prompt_history import PromptHistories
from ai_ops.models.access_grants import AccessGrantModel, AccessGrants
...
class PromptsTable:
    ...
    def search_prompts(
        ...
        with get_db_context(db) as db:
            from ai_ops.models.users import User, UserModel
