...
from ai_ops.utils.misc import is_string_allowed
from ai_ops.models.oauth_sessions import OAuthSessions
from ai_ops.models.chats import Chats
from ai_ops.models.folders import Folders
from ai_ops.models.users import Users
from ai_ops.socket.main import (
    get_event_call,
    get_event_emitter,
)
from ai_ops.routers.tasks import (
    generate_queries,
    generate_title,
    generate_follow_ups,
...
from ai_ops.routers.retrieval import (
    process_web_search,
    SearchForm,
)
from ai_ops.utils.tools import get_builtin_tools
from ai_ops.routers.images import (
    image_generations,
    CreateImageForm,
    image_edits,
    EditImageForm,
)
from ai_ops.routers.pipelines import (
    process_pipeline_inlet_filter,
    process_pipeline_outlet_filter,
)
from ai_ops.routers.memories import query_memory, QueryMemoryForm

from ai_ops.utils.webhook import post_webhook
from ai_ops.utils.files import (
...
from ai_ops.models.users import UserModel
from ai_ops.models.functions import Functions
from ai_ops.models.models import Models

from ai_ops.retrieval.utils import get_sources_from_items


from ai_ops.utils.sanitize import sanitize_code
from ai_ops.utils.chat import generate_chat_completion
from ai_ops.utils.task import (
    get_task_model_id,
    rag_template,
...
from ai_ops.utils.tools import (
    get_tools,
    get_updated_tool_function,
    get_terminal_tools,
)
from ai_ops.utils.access_control import has_connection_access
from ai_ops.utils.plugin import load_function_module_by_id
from ai_ops.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)
from ai_ops.utils.code_interpreter import execute_code_jupyter
from ai_ops.utils.payload import apply_system_prompt_to_body
from ai_ops.utils.response import normalize_usage
from ai_ops.utils.mcp.client import MCPClient
...
from ai_ops.utils.headers import include_user_info_headers
from ai_ops.constants import TASKS
...
def serialize_output(output: list) -> str:
    ...
    for idx, item in enumerate(output):
        ...
        elif item_type == 'ai_ops:code_interpreter':
...
async def process_chat_payload(request, form_data, user, metadata, model):
    ...
    available_skills = []
    if all_skill_ids:
        from ai_ops.models.skills import Skills as SkillsModel
        ...
        async def response_handler(response, events):
            def tag_output_handler(content_type, tags, output):
                ...
                output_type_map = {
                    ...
                    'code_interpreter': 'ai_ops:code_interpreter',
                }
                ...
                if last_type == 'message':
                    ...
                    for start_tag, end_tag in tags:
                        ...
                        if match:
                            ...
                            elif output_item_type == 'ai_ops:code_interpreter':
                                output.append(
                                    {
                                        'type': 'ai_ops:code_interpreter',
                                        'id': output_id('ci'),
                                        'status': 'in_progress',
                                        'start_tag': start_tag,
                                        'end_tag': end_tag,
                    ...
                    or (last_type == 'ai_ops:code_interpreter' and content_type == 'code_interpreter')
                    ...
                    elif last_type == 'ai_ops:code_interpreter':
            ...
            try:
                                    ...
                                    if value:
                                        ...
                                        inside_tag_block = (
                                            ...
                                            and (
                                                ...
                                                or last_item_type == 'ai_ops:code_interpreter'
                                                or (
                                        ...
                                        if inside_tag_block:
                                            ...
                                            if last_item_type == 'ai_ops:code_interpreter':
                ...
                if DETECT_CODE_INTERPRETER:
                    ...
                    while output and output[-1].get('type') == 'ai_ops:code_interpreter' and retries < MAX_RETRIES:
                        await event_emitter(
                            {
                                'type': 'chat:completion',
                                'data': {
