...
def version_callback(value: bool) -> None:
    if value:
        from ai_ops.env import VERSION

        typer.echo(f'ai.ops version: {VERSION}')
        raise typer.Exit()
...
def serve(
    ...
    import ai_ops.main  # noqa: F401
    from ai_ops.env import UVICORN_WORKERS  # Import the workers setting
