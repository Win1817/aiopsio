...
from ai_ops.utils.anthropic import is_anthropic_url, get_anthropic_models
...
def _normalize_stored_item(item: dict) -> dict:
    ...
    ai.ops stores extra bookkeeping fields (``id``, ``status``,
...
async def generate_chat_completion(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail='ai.ops: Server Connection Error',
        )
    finally:
        if not streaming:
