...
from ai_ops.routers.pipelines import process_pipeline_inlet_filter

from ai_ops.utils.task import get_task_model_id
...
async def check_active_chats(request: Request, form_data: ActiveChatsForm, user=Depends(get_verified_user)):
    ...
    from ai_ops.tasks import get_active_chat_ids
