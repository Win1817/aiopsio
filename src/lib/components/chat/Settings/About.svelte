	...
	<div class=" space-y-3 overflow-y-scroll max-h-[28rem] md:max-h-full">
			...
			<div class="flex w-full justify-between items-center">
				<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
					<div class="flex gap-1">
						...
						{#if $config?.features?.enable_version_update_check}
							<a
								href="https://github.com/ai-ops/ai-ops/releases/tag/v{version.latest}"
								target="_blank"
							>
								{updateAvailable === null
		...
		{:else}
			<div class="flex space-x-1">
				...
				<a href="https://github.com/ai-ops/ai-ops" target="_blank">
					<img
						alt="Github Repo"
						src="https://img.shields.io/github/stars/ai-ops/ai-ops?style=social&label=Star us on Github"
					/>
				</a>
			</div>
		{/if}
		...
		<div>
			<pre
				class="text-xs text-gray-400 dark:text-gray-500">Copyright (c) {new Date().getFullYear()} <a
					...
					target="_blank"
					class="underline">ai.ops Inc.</a
				> <a href="https://github.com/ai-ops/ai-ops/blob/main/LICENSE" target="_blank"
